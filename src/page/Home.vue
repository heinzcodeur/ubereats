<template>
    <div class="home">
        <div class="header">
            ...
            }"><img src="https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/ee037401cb5d31b23cf780808ee4ec1f.svg" alt=""></a>
        ...
        <!--MonComposant v-for="(data, i) in tab" :key="i" :compo="data"/-->
